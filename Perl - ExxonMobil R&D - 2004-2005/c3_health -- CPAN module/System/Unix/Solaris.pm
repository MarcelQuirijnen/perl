...
# Initialize with Solaris specific stuff
sub _initialize
{
  my $self = shift;
  ...
  $self->{FILES} = { SYSLOG      => '/var/adm/messages',
                     SYSMONLOG   => '/var/adm/sysmond.log',
                   };
...
System::Unix::Solaris - SUN Solaris system info
